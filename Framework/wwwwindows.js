...
$(document).ready(() => {
    ...
    $(".window").each((index, elem) => Add(elem))
...
function Add(window) {
    ...
    let top = $(window).data("top") || 50
    let left = $(window).data("left") || 50
    let width = $(window).data("width") || 600
    let height = $(window).data("height") || 400
    ...
    $(newtemp).css({
        ...
        "border": "1px solid rgba(0, 0, 0, 0.35)", "overflow": "hidden",
        "box-sizing": "border-box"
    });
    $(newtemp).children(":first-child").css({
        "width": "100%",
        "height": "32px", "background-color": "silver", "margin": "0", "padding": "0",
        "-webkit-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none",
        "user-select": "none", "box-sizing": "border-box"
    });
    $(newtemp).children(":first-child").children().css({
        "float": "right",
        "padding": "3px 10px 0 10px", "margin": "0", "color": "rgba(0, 0, 0, 0.7)",
        "box-sizing": "border-box"
    });
    let child = $(window).children(":first-child");
    $(child).css({
        "width": "100%", "height": "100%",
        "margin": "0", "padding": "5px 5px 7px 5px", "overflow": "auto",
        "box-sizing": "border-box"
    });
    $(newtemp).append($(child));
    $(window).remove();
